...
<html>
    ...
    <body style="background-color: gray">
        <header >
            ...
            <h2 style="text-align: center; margin:20px 0">Cadastrar - Clientes</h2>
        </header>
        
        <fieldset  style="width: 50vw; margin: auto; " >
            <legend></legend>
            <form class="form-control bg-dark" data-bs-theme="dark" style="border-radius: 10px" action="/SistemaComercial/SvCliente" method="POST">
            <label for="name">Nome:</label>
            <input class="form-control bg-light-subtle" type="text" name="name" id="name">
            </br>
            <label for="cpf">CPF:</label>
            <input class="form-control bg-light-subtle" type="text" name="cpf" id="cpf">
            </br>
            <label for="email">Email:</label>
            <input class="form-control bg-light-subtle" type="text" name="email" id="email">
            </br>
            <label for="celular">Telefone:</label>
            <input class="form-control bg-light-subtle" type="text" name="celular" id="tel">
            </br>
